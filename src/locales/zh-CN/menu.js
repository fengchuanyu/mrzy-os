export default {
  ...
  'menu.doctor': '医生列表',
  'menu.doctor.list1': '医生列表',
  'menu.doctor.list2': '添加医生',
  'menu.casehistory': '病例管理',
  'menu.casehistory.caselist': '病例列表',
  'menu.casehistory.casesend': '病例发布',
  'menu.casehistory.registration': '挂号列表',
  'menu.message': '文章管理',
  'menu.feature': '特色诊疗',
  'menu.userlist': '用户列表',
